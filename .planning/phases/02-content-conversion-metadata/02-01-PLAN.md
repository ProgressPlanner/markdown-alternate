...
must_haves:
  truths:
    - "HTML content converts to clean markdown with proper formatting"
    - "Dangerous HTML like script, style, and iframe tags are removed from output"
    - "Empty HTML input returns empty markdown without errors"
  artifacts:
    - path: "composer.json"
